                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-4">
			                    ...
			                    <br />
                                <asp:Button ID="btnBajaTorneo" runat="server" Text="Eliminar" class="btn btn-default" OnClientClick="return confirm('¿Esta seguro que desea eliminar este torneo?');return false;"/>
	                        </div>
                         </div>
                    </div>  
                </div>             
